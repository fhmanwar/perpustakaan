<?php if($peminjaman->status_kembali == "Sudah") {?>
  <button class="btn btn-success btn-sm disabled" data-toggle="modal" data-target="#Kembali<?php echo $peminjaman->id_peminjaman ?>" title="Delete User">
    <i class="fa fa-check"></i> Kembali
  </button>

<?php }else{ ?>
<button class="btn btn-success btn-sm" data-toggle="modal" data-target="#Kembali<?php echo $peminjaman->id_peminjaman ?>" title="Delete User">
  <i class="fa fa-check"></i> Kembali
</button>
